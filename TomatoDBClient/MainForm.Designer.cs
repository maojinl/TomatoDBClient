...
namespace TomatoDBClient
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTipDownloadPS.SetToolTip(this.btnConnect, "Start selected game");
            ...
            this.toolTipDownloadPS.SetToolTip(this.btnCreate, "Stop currently running game");
            ...
            this.toolTipDownloadPS.SetToolTip(this.btnSetKeyValue, "Stop currently running game");
            ...
            this.toolTipDownloadPS.SetToolTip(this.btnDeleteKeyValue, "Stop currently running game");
            ...
            this.toolTipDownloadPS.SetToolTip(this.btnDelete, "Stop currently running game");
            ...
            this.toolTipDownloadPS.SetToolTip(this.btnGetKeyValue, "Stop currently running game");
            ...
            this.panel2.Location = new System.Drawing.Point(669, -5);
            ...
            this.listDatabases.Size = new System.Drawing.Size(868, 446);
            this.listDatabases.TabIndex = 1;
            this.listDatabases.SelectedIndexChanged += new System.EventHandler(this.listGames_SelectedIndexChanged);
            // 
            // splitContainer1
            // 
